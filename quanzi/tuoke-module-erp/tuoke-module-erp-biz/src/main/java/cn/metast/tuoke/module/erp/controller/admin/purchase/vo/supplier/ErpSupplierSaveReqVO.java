package cn.metast.tuoke.module.erp.controller.admin.purchase.vo.supplier;
...
public class ErpSupplierSaveReqVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
    @NotEmpty(message = "供应商名称不能为空")
    private String name;

    @Schema(description = "联系人", example = "元圈")
