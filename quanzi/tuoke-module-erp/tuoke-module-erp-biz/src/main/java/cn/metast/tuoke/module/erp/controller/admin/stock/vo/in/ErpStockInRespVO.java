package cn.metast.tuoke.module.erp.controller.admin.stock.vo.in;
...
import static cn.metast.tuoke.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockInRespVO {
    ...
    @Schema(description = "供应商名称", example = "元圈")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "附件 URL", example = "https://www.metast.cn/1.doc")
    private String fileUrl;

    @Schema(description = "创建人", example = "元圈")
    private String creator;
    @Schema(description = "创建人名称", example = "元圈")
