package cn.metast.tuoke.module.system.enums.social;
...
public enum SocialTypeEnum implements ArrayValuable<Integer> {
     ...
     * @see <a href="https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/login.html">接入文档</a>
     */
    WECHAT_MINI_STORE(36, "WECHAT_MINI_STORE"),
     ...
     * @see <a href="https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/login.html">接入文档</a>
     */
    WECHAT_MINI_TECH(38, "WECHAT_MINI_TECH"),
     ...
     * @see <a href="https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/login.html">接入文档</a>
     */
    WECHAT_MINI_SERVICE(40, "WECHAT_MINI_TECH"),

    /**
     * 免登录
     * 来源直播登录，
     */
    AUTH_CODE_LOGIN(101, "NO_CODE_LOGIN"),
    ;
