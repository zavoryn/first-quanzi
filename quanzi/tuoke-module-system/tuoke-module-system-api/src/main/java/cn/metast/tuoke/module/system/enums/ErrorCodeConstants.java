package cn.metast.tuoke.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode AUTH_LOGIN_BAD_NOUSER = new ErrorCode(1_002_000_000, "登录失败，登录用户不存在");
    ...
    ErrorCode USER_IMPORT_LIST_IS_EMPTY = new ErrorCode(1_002_003_004, "导入用户不能为空！");
