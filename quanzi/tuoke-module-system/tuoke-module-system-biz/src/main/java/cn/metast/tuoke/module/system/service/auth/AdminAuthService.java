...
public interface AdminAuthService {
     ...
     * @return 登录结果
     */
    AuthLoginRespVO aiLogin(AuthLoginReqVO reqVO);
    /**
     * 基于 token 退出登录
     *
     * @param token token
    ...
    JSONObject syncUserById(Long userId, String optCode);
    JSONObject syncUserByIdNoToken(Long userId, String optCode);
    JSONObject lxLogin(Long userId);
    JSONObject sendMessage(String message,Long kefuId);
    void lxLogout();

    String zbLogin();
    boolean verifyCookie(String cookie);
