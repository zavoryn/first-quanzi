package cn.metast.tuoke.module.system.controller.admin.user;
...
import cn.metast.tuoke.module.system.controller.admin.user.vo.profile.UserProfileRespVO;
...
import static cn.metast.tuoke.module.infra.enums.ErrorCodeConstants.FILE_IS_EMPTY;
...
public class UserProfileController {
    ...
    public CommonResult<Boolean> updateUserProfile(@Valid @RequestBody UserProfileUpdateReqVO reqVO) {
        ...
        authService.syncUserById(getLoginUserId(), AuthConstans.UPDATE);
        return success(true);
    }
