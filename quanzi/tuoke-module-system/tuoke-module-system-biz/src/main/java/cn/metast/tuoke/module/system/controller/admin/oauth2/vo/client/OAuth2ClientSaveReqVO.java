package cn.metast.tuoke.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientSaveReqVO {
    ...
    @Schema(description = "应用图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/xx.png")
    ...
    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn")
