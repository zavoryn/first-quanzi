...
import cn.metast.tuoke.module.system.convert.oauth2.OAuth2OpenConvert;
...
import cn.metast.tuoke.module.system.util.oauth2.OAuth2Utils;
...
import static cn.metast.tuoke.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.metast.cn"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.metast.cn"),
