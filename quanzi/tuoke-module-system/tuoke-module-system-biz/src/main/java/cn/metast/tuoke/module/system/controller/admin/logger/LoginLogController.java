package cn.metast.tuoke.module.system.controller.admin.logger;
...
public class LoginLogController {
    ...
    public CommonResult<PageResult<LoginLogRespVO>> getLoginLogPage(@Valid LoginLogPageReqVO pageReqVO) {
        return success(loginLogService.getLoginLogPageWithNickname(pageReqVO));
    }
    ...
    public void exportLoginLog(HttpServletResponse response, @Valid LoginLogPageReqVO exportReqVO) throws IOException {
        ...
        PageResult<LoginLogRespVO> pageResult = loginLogService.getLoginLogPageWithNickname(exportReqVO);
        ExcelUtils.write(response, "登录日志.xls", "数据列表", LoginLogRespVO.class, pageResult.getList());
    }
