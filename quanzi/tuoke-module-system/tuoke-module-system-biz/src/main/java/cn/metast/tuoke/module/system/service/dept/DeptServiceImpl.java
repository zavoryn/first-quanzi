...
public class DeptServiceImpl implements DeptService {
    ...
    public List<DeptDO> getDeptList(DeptListReqVO reqVO) {
        ...
        List<DeptDO> childDepts = getChildDeptList(loginUserDeptId);
        if (CollUtil.isNotEmpty(childDepts)) {
            deptIds.addAll(convertSet(childDepts, DeptDO::getId));
        }
        ...
        list = list.stream()
                ...
                .sorted(Comparator.comparing(DeptDO::getSort))
