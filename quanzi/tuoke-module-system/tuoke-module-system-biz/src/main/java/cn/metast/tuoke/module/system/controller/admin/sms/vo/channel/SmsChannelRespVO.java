package cn.metast.tuoke.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelRespVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "tuoke")
    ...
    @Schema(description = "短信发送回调 URL", example = "https://www.metast.cn")
