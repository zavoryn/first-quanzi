...
public interface OperateLogMapper extends BaseMapperX<OperateLogDO> {
    ...
    default PageResult<OperateLogDO> selectPageByUserIds(OperateLogPageReqVO pageReqDTO, List<Long> userIds) {
        return selectPage(pageReqDTO, new LambdaQueryWrapperX<OperateLogDO>()
    ...
    default PageResult<OperateLogDO> selectPageByOrderIds(OperateLogPageReqVO pageReqDTO, List<Long> orderIds) {
        return selectPage(pageReqDTO, new LambdaQueryWrapperX<OperateLogDO>()
                .inIfPresent(OperateLogDO::getUserId, orderIds)
                .eqIfPresent(OperateLogDO::getUserId, pageReqDTO.getUserId())
                .eqIfPresent(OperateLogDO::getBizId, pageReqDTO.getBizId())
                .likeIfPresent(OperateLogDO::getType, pageReqDTO.getType())
                .likeIfPresent(OperateLogDO::getSubType, pageReqDTO.getSubType())
    ...
    default PageResult<OperateLogDO> selectPageByOrderIds(OperateLogPageReqDTO pageReqDTO, List<Long> orderIds) {
        return selectPage(pageReqDTO, new LambdaQueryWrapperX<OperateLogDO>()
                .inIfPresent(OperateLogDO::getUserId, orderIds)
                .eqIfPresent(OperateLogDO::getType, pageReqDTO.getType())
                .eqIfPresent(OperateLogDO::getBizId, pageReqDTO.getBizId())
    ...
    default PageResult<OperateLogDO> selectPageByUserIds(OperateLogPageReqDTO pageReqDTO, List<Long> userIds) {
        return selectPage(pageReqDTO, new LambdaQueryWrapperX<OperateLogDO>()
                .inIfPresent(OperateLogDO::getUserId, userIds)
                .eqIfPresent(OperateLogDO::getType, pageReqDTO.getType())
                .eqIfPresent(OperateLogDO::getBizId, pageReqDTO.getBizId())
