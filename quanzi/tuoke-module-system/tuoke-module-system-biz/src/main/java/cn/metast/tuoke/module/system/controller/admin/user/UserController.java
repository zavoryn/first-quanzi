...
public class UserController {
    ...
    public CommonResult<Long> createUser(@Valid @RequestBody UserSaveReqVO reqVO) {
        ...
        authService.syncUserById(id, AuthConstans.INSERT);
        return success(id);
    }
    ...
    public CommonResult<Boolean> updateUser(@Valid @RequestBody UserSaveReqVO reqVO) {
        ...
        authService.syncUserById(reqVO.getId(), AuthConstans.UPDATE);
        return success(true);
    }
    ...
    public CommonResult<Boolean> deleteUser(@RequestParam("id") Long id) {
        authService.syncUserById(id, AuthConstans.DELETE);
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunai@metast.cn").mobile("15601691300")
                        .nickname("元圈").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("yuanma").deptId(2L).email("yuanma@metast.cn").mobile("15601701300")
