package cn.metast.tuoke.module.system.controller.admin.socail.vo.client;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "tuoke商城")
