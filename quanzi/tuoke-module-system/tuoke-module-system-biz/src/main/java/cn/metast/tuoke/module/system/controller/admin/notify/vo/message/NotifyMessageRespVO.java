package cn.metast.tuoke.module.system.controller.admin.notify.vo.message;
...
public class NotifyMessageRespVO {
    ...
    @Schema(description = "模版发送人名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
