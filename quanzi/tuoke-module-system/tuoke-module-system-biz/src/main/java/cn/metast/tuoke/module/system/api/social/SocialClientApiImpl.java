...
import cn.metast.tuoke.module.system.dal.dataobject.social.SocialClientDO;
import cn.metast.tuoke.module.system.dal.mysql.social.SocialClientMapper;
...
public class SocialClientApiImpl implements SocialClientApi {
    ...
    @Override
    public String getWxUnionid(Integer userType, String loginCode) {
        return socialClientService.getWxUnionid(userType,loginCode);
    }
    ...
    @Override
    public String getLinkUrl(String pageUrl,String title) {
        return socialClientService.getLinkUrl(pageUrl,title);
    }

    @Override
    public String getShortUrl(String pageUrl, String title) {
        return socialClientService.getShortUrl(pageUrl,title);
    }
    ...
    @Override
    public Map<String, Object> getWxxdKey() {
        SocialClientDO socialClientDO=socialClientMapper.selectBySocialTypeAndUserType(SocialTypeEnum.WECHAT_MINI_TECH.getType(),1);
        if(socialClientDO==null){
            return null;
        }
        Map<String, Object> mm=new HashMap<>();
        mm.put("app_id",socialClientDO.getAgentId());
        mm.put("client_id",socialClientDO.getClientId());
        mm.put("secret_key",socialClientDO.getClientSecret());
        return mm;
    }
    @Override
    public Map<String, Object> getWxServiceKey() {
        SocialClientDO socialClientDO=socialClientMapper.selectBySocialTypeAndUserType(SocialTypeEnum.WECHAT_MINI_SERVICE.getType(),1);
        if(socialClientDO==null){
            return null;
        }
        Map<String, Object> mm=new HashMap<>();
    ...
    @Override
    public String getWxxxhServiceKey() {
        return socialClientService.getWxxxhServiceKey();
      /*  SocialClientDO socialClientDO=socialClientMapper.selectBySocialTypeAndUserType(SocialTypeEnum.WECHAT_MINI_APP.getType(),1);
        if(socialClientDO==null){
            return null;
        }
        Map<String, Object> mm=new HashMap<>();
    ...
    @Override
    public String getWxAppIdKey() {
        SocialClientDO socialClientDO=socialClientMapper.selectBySocialTypeAndUserType(SocialTypeEnum.WECHAT_MINI_APP.getType(),1);
        return socialClientDO.getClientId();
    }
}
