package cn.metast.tuoke.module.system.controller.admin.oauth2;
...
import cn.metast.tuoke.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import cn.metast.tuoke.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import cn.metast.tuoke.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import cn.metast.tuoke.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import cn.metast.tuoke.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import cn.metast.tuoke.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import cn.metast.tuoke.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import cn.metast.tuoke.module.system.service.oauth2.OAuth2ApproveService;
import cn.metast.tuoke.module.system.service.oauth2.OAuth2ClientService;
import cn.metast.tuoke.module.system.service.oauth2.OAuth2GrantService;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        String clientId = randomString();
        String scope = "{\"read\": true, \"write\": false}";
        String redirectUri = "https://www.metast.cn";
        String state = "test";
        // mock 方法
        OAuth2ClientDO client = randomPojo(OAuth2ClientDO.class);
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.metast.cn#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("https://www.metast.cn#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("https://www.metast.cn#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.metast.cn?code=test_code&state=test", result.getData());
    }
