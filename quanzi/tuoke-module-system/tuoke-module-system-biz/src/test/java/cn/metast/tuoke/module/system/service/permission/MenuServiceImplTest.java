...
import cn.metast.tuoke.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import cn.metast.tuoke.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import cn.metast.tuoke.module.system.dal.dataobject.permission.MenuDO;
import cn.metast.tuoke.module.system.dal.mysql.permission.MenuMapper;
import cn.metast.tuoke.module.system.enums.permission.MenuTypeEnum;
...
import static cn.metast.tuoke.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("元圈").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
