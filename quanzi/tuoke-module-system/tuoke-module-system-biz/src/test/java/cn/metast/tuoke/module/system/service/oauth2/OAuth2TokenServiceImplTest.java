package cn.metast.tuoke.module.system.service.oauth2;
...
import cn.metast.tuoke.module.system.controller.admin.oauth2.vo.token.OAuth2AccessTokenPageReqVO;
...
import cn.metast.tuoke.module.system.dal.dataobject.oauth2.OAuth2RefreshTokenDO;
import cn.metast.tuoke.module.system.dal.dataobject.user.AdminUserDO;
import cn.metast.tuoke.module.system.dal.mysql.oauth2.OAuth2AccessTokenMapper;
import cn.metast.tuoke.module.system.dal.mysql.oauth2.OAuth2RefreshTokenMapper;
import cn.metast.tuoke.module.system.dal.redis.oauth2.OAuth2AccessTokenRedisDAO;
...
public class OAuth2TokenServiceImplTest extends BaseDbAndRedisUnitTest {
    ...
    public void testCreateAccessToken() {
        ...
        // TODO @元圈：expiresTime 被屏蔽，仅 win11 会复现，建议后续修复。
