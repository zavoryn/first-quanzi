package cn.metast.tuoke.module.system.service.tenant;

import cn.metast.tuoke.framework.common.enums.CommonStatusEnum;
import cn.metast.tuoke.framework.common.pojo.PageResult;
import cn.metast.tuoke.framework.tenant.config.TenantProperties;
...
import cn.metast.tuoke.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
...
import cn.metast.tuoke.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.metast.tuoke.module.system.dal.mysql.tenant.TenantMapper;
import cn.metast.tuoke.module.system.enums.permission.RoleCodeEnum;
import cn.metast.tuoke.module.system.enums.permission.RoleTypeEnum;
...
import cn.metast.tuoke.module.system.service.tenant.handler.TenantInfoHandler;
import cn.metast.tuoke.module.system.service.tenant.handler.TenantMenuHandler;
...
import static cn.metast.tuoke.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("元圈", user.getNickname());
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            ...
            o.setWebsite("https://www.metast.cn");
            o.setUsername("yunai");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("元圈"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("元圈");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsite("https://www.metast.cn"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.metast.cn");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
