package cn.metast.tuoke.module.system.service.user;
...
import cn.metast.tuoke.framework.common.util.collection.ArrayUtils;
...
import cn.metast.tuoke.module.infra.api.config.ConfigApi;
import cn.metast.tuoke.module.infra.api.file.FileApi;
import cn.metast.tuoke.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.metast.tuoke.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
...
import cn.metast.tuoke.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.metast.tuoke.module.system.dal.mysql.dept.UserPostMapper;
import cn.metast.tuoke.module.system.dal.mysql.user.AdminUserMapper;
import cn.metast.tuoke.module.system.enums.common.SexEnum;
...
import static cn.metast.tuoke.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("tuokeyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("tuokeyuanma");
        ...
        assertEquals("tuokeyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("tuokeyuanma"))).thenReturn("java");
