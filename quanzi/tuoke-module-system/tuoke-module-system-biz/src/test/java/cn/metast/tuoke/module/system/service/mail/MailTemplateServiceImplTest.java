package cn.metast.tuoke.module.system.service.mail;
...
import cn.metast.tuoke.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.metast.tuoke.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.metast.tuoke.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.metast.tuoke.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.metast.tuoke.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("元圈")));
        // 测试 code 不匹配
