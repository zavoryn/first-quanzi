package cn.metast.tuoke.module.mp.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode TASK_NOT_EXISTS = new ErrorCode(1_006_009_004, "自动开发公众号信息不存在");
    ErrorCode TASK_RECORD_NOT_EXISTS = new ErrorCode(1_006_009_005, "公众号发送记录不存在");
    ErrorCode TASK_TEMPLATE_NOT_EXISTS = new ErrorCode(1_006_009_006, "公众号模板不存在");
}
