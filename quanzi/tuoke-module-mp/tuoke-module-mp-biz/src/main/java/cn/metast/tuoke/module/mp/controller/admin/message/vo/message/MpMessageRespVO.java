package cn.metast.tuoke.module.mp.controller.admin.message.vo.message;
...
public class MpMessageRespVO {
    ...
    @Schema(description = "媒体文件的 URL 消息类型为 image、voice、video 时，才有值", example = "https://www.metast.cn/xxx.png")
    ...
    @Schema(description = "缩略图的媒体 URL 消息类型为 video、music 时，才有值", example = "https://www.metast.cn/xxx.png")
    private String thumbMediaUrl;

    @Schema(description = "点击图文消息跳转链接 消息类型为 link 时，才有值", example = "https://www.metast.cn")
    private String url;
    ...
    @Schema(description = "音乐链接 消息类型为 music 时，才有值", example = "https://www.metast.cn/xxx.mp3")
    private String musicUrl;
    @Schema(description = "高质量音乐链接 消息类型为 music 时，才有值", example = "https://www.metast.cn/xxx.mp3")
