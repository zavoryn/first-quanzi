package cn.metast.tuoke.module.mp.controller.admin.material;

import cn.metast.tuoke.framework.common.pojo.CommonResult;
import cn.metast.tuoke.framework.common.pojo.PageResult;
import cn.metast.tuoke.module.mp.controller.admin.material.vo.*;
...
public class MpMaterialController {
    ...
    @Operation(summary = "上传永久素材")
    @PostMapping("/upload-permanent-url")
    @PreAuthorize("@ss.hasPermission('mp:material:upload-permanent')")
    public CommonResult<MpMaterialUploadRespVO> uploadPermanentMaterialUrl(
            @RequestParam(name = "accountId") Long accountId,
            @RequestParam(name = "url") String url) throws IOException {
        MpMaterialDO material = mpMaterialService.uploadPermanentMaterialURL(accountId,url);
        return success(MpMaterialConvert.INSTANCE.convert(material));
    }
