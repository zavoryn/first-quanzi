package cn.metast.tuoke.module.mp.controller.admin.material.vo;
...
public class MpMaterialRespVO {
    ...
    @Schema(description = "素材的 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/1.png")
    private String url;
