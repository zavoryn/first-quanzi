package cn.metast.tuoke.module.mp.service.account;
...
import cn.metast.tuoke.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.metast.tuoke.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.metast.tuoke.module.mp.convert.account.MpAccountConvert;
...
import cn.metast.tuoke.module.mp.enums.ErrorCodeConstants;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 tuoke-module-mp - 表结构未导入][参考 https://doc.metast.cn/mp/build/ 开启]");
            }
