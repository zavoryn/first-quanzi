...
public class MpMessageSendReqVO {
    ...
    @Schema(description = "音乐链接 消息类型为 MUSIC 时", example = "https://www.metast.cn/music.mp3")
    private String musicUrl;

    @Schema(description = "高质量音乐链接 消息类型为 MUSIC 时", example = "https://www.metast.cn/music.mp3")
