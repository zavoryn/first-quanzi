package cn.metast.tuoke.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import cn.metast.tuoke.framework.common.pojo.PageResult;
import cn.metast.tuoke.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import cn.metast.tuoke.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import cn.metast.tuoke.module.mp.convert.message.MpMessageConvert;
import cn.metast.tuoke.module.mp.dal.dataobject.account.MpAccountDO;
import cn.metast.tuoke.module.mp.dal.dataobject.message.MpMessageDO;
import cn.metast.tuoke.module.mp.dal.dataobject.user.MpUserDO;
import cn.metast.tuoke.module.mp.dal.mysql.message.MpMessageMapper;
import cn.metast.tuoke.module.mp.enums.message.MpMessageSendFromEnum;
import cn.metast.tuoke.module.mp.framework.mp.core.MpServiceFactory;
import cn.metast.tuoke.module.mp.framework.mp.core.util.MpUtils;
...
import cn.metast.tuoke.module.mp.service.user.MpUserService;
...
import static cn.metast.tuoke.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
