package cn.metast.tuoke.module.mp.controller.admin.message.vo.autoreply;

import cn.hutool.core.util.ObjectUtil;
import cn.metast.tuoke.module.mp.dal.dataobject.message.MpMessageDO;
import cn.metast.tuoke.module.mp.enums.message.MpAutoReplyTypeEnum;
...
public class MpAutoReplyBaseVO {
    ...
    @Schema(description = "回复的媒体 URL", example = "https://www.metast.cn/xxx.jpg")
    @NotEmpty(message = "回复的消息 mediaId 不能为空",
            groups = {ImageMessageGroup.class, VoiceMessageGroup.class, VideoMessageGroup.class})
    ...
    @Schema(description = "缩略图的媒体 URL",example = "https://www.metast.cn/xxx.jpg")
    ...
    @Schema(description = "回复的音乐链接", example = "https://www.metast.cn/xxx.mp3")
    ...
    @Schema(description = "高质量音乐链接", example = "https://www.metast.cn/xxx.mp3")
