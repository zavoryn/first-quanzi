package cn.metast.tuoke.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
    @NotEmpty(message = "公众号名称不能为空")
    private String name;

    @Schema(description = "公众号微信号", requiredMode = Schema.RequiredMode.REQUIRED, example = "tuokeyuanma")
    ...
    @Schema(description = "备注", example = "请关注元圈，学习技术")
