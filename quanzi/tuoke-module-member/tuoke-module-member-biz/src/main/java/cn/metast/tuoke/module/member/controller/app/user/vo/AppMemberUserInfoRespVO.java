package cn.metast.tuoke.module.member.controller.app.user.vo;
...
public class AppMemberUserInfoRespVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/xxx.png")
    ...
    public static class Level {
        ...
        @Schema(description = "等级名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
        private String name;

        @Schema(description = "等级", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
        private Integer level;

        @Schema(description = "等级图标", example = "https://www.metast.cn/tuoke.jpg")
        private String icon;
