package cn.metast.tuoke.module.member.controller.app.auth;
...
import cn.metast.tuoke.module.member.service.auth.MemberAuthService;
...
public class AppAuthController {
    ...
    @PostMapping("/sms-login-internal")
    @Operation(summary = "使用手机 登录")
    @PermitAll
    public CommonResult<AppAuthLoginRespVO> smsLoginInternal(@RequestBody @Valid AppAuthSmsLoginReqVO reqVO) {
        return success(authService.smsLogin(reqVO));
    }
