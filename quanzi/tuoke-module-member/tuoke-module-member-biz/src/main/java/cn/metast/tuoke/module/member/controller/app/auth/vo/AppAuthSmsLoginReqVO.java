package cn.metast.tuoke.module.member.controller.app.auth.vo;
...
//    @Pattern(regexp = "^[0-9]+$", message = "手机验证码必须都是数字")
    ...
    @Schema(description = "socialKey", requiredMode = Schema.RequiredMode.REQUIRED, example = "d41980bd-af66-4e93-b1ef-ad3d8e4ef51d")
    private String socialKey;

    @Schema(description = "直播系统用户ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "0")
