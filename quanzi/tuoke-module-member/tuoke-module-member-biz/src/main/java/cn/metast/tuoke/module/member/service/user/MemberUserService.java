...
public interface MemberUserService {
    ...
    MemberUserDO getUserByNickName(String nickName);

    MemberUserDO selectByTechUserId(String userId);
    /**
     * 基于用户昵称，模糊匹配用户列表
     *
    ...
    MemberUserDO createUserIfAbsent(@Mobile String mobile, String registerIp, Integer terminal, String anchorId);
    ...
    MemberUserDO getUserByAnchorId(Long anchorId);
     ...
     * @return 导入结果
     */
    MemberUserImportRespVO importUserList(List<MemberUserImportExcelVO> importUsers, boolean isUpdateSupport);
