...
import cn.metast.tuoke.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import cn.metast.tuoke.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, TuokeRedisAutoConfiguration.class})
