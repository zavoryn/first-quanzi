...
public interface MemberUserApi {
    ...
    MemberUserRespDTO getUserByAnchorId(Long anchorId);
    ...
    MemberUserRespDTO getUserByNickName(String nickname);

    MemberUserRespDTO selectByTechUserId(String userId);
    /**
     * 校验用户是否存在
     *
     * @param id 用户编号
    ...
    Boolean updateUserMark(Long userId, String introduction);
}
