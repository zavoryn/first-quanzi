...
@Schema(description = "管理后台 - 收藏记录分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class CmCollectPageReqVO extends PageParam {

    @Schema(description = "用户id", example = "24529")
    private Long userId;

    @Schema(description = "收藏的帖子id", example = "14267")
    private Long postId;
