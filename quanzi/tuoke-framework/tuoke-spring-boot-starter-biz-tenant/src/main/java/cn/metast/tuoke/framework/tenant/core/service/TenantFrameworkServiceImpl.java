package cn.metast.tuoke.framework.tenant.core.service;
...
public class TenantFrameworkServiceImpl implements TenantFrameworkService {
     ...
     */
    @Override
    public void refreshTenantIdsCache() {
        getTenantIdsCache.invalidate(Boolean.TRUE); // 清除特定key
        // 或 getTenantIdsCache.invalidateAll(); // 清除全部
    }
     ...
     */
    @Override
    public void refreshValidTenantCache(Long tenantId) {
        validTenantCache.invalidate(tenantId);
    }
