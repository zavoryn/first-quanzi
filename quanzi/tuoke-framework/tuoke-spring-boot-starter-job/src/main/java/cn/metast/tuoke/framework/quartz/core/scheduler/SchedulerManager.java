package cn.metast.tuoke.framework.quartz.core.scheduler;

import cn.metast.tuoke.framework.quartz.core.enums.JobDataKeyEnum;
import cn.metast.tuoke.framework.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw exception0(NOT_IMPLEMENTED.getCode(),
                    "[定时任务 - 已禁用][参考 https://doc.metast.cn/job/ 开启]");
        }
    }
