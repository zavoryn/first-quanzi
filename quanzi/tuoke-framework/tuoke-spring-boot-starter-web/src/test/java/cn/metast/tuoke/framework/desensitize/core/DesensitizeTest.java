package cn.metast.tuoke.framework.desensitize.core;

import cn.metast.tuoke.framework.common.util.json.JsonUtils;
import cn.metast.tuoke.framework.desensitize.core.annotation.Address;
import cn.metast.tuoke.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.metast.tuoke.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.metast.tuoke.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("元圈");
        ...
        desensitizeDemo.setRegex("你好，我是元圈");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("元圈");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "元圈", replacer = "*")
