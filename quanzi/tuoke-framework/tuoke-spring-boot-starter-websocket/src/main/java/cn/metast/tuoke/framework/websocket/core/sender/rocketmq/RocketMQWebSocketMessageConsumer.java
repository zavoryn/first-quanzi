package cn.metast.tuoke.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${tuoke.websocket.sender-rocketmq.topic}",
        consumerGroup = "${tuoke.websocket.sender-rocketmq.consumer-group}",
