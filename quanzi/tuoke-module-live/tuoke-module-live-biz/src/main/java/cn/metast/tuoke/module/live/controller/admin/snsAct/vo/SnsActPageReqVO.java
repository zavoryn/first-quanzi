...
@Schema(description = "管理后台 - 活动详情分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class SnsActPageReqVO extends PageParam {

    @Schema(description = "act_id", example = "7182")
    private Long actId;

    @Schema(description = "post_id", example = "14122")
    private Long postId;

    @Schema(description = "活动类型，字典：活动act/课程:course/会务:meeting", example = "1")
    private String actType;

    @Schema(description = "活动形式（线下 0 线上1 模板2）")
