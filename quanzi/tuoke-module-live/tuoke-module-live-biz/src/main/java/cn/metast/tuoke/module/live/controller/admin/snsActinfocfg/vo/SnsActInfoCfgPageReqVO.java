...
@Schema(description = "管理后台 - 报名填写信息设置分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class SnsActInfoCfgPageReqVO extends PageParam {

    @Schema(description = "act_id", example = "30344")
    private Long actId;
    ...
    @Schema(description = "字段类型1 单行输入 2 多行输入 3 数字 4 单选 5 多选", example = "1")
