...
@Schema(description = "管理后台 - 动态信息新增/修改 Request VO")
@Data
public class SnsPostSaveReqVO {
    ...
    @NotEmpty(message = "类型(dyna 动态 act  活动 bus 商机 ent 企业家 spe 智库 srv  服务 news新闻,community社区,magazine 内刊)不能为空")
    ...
    @NotNull(message = "隐私设置(0 所有人 2 关注我的人  4仅自己 )不能为空")
