...
import cn.metast.tuoke.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import cn.metast.tuoke.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link cn.metast.tuoke.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getJavaField(), "name")) {
            column.setExample(randomEle(new String[]{"张三", "李四", "王五", "赵六", "元圈"}));
            return;
        }
        // status
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.metast.cn");
            return;
        }
        // reason
