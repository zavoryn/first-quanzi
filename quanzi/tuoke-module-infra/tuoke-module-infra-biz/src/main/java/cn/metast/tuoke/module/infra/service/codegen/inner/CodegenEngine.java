package cn.metast.tuoke.module.infra.service.codegen.inner;
...
import cn.metast.tuoke.framework.apilog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "tuoke-module-${table.moduleName}/" + // 顶级模块
                "tuoke-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "tuoke-module-${table.moduleName}/" + // 顶级模块
                "tuoke-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "tuoke-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "tuoke-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
