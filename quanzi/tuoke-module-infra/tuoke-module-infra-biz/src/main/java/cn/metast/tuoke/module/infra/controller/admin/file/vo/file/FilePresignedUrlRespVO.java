package cn.metast.tuoke.module.infra.controller.admin.file.vo.file;
...
public class FilePresignedUrlRespVO {
    ...
    @Schema(description = "文件访问 URL", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "https://test.tuoke.metast.cn/758d3a5387507358c7236de4c8f96de1c7f5097ff6a7722b34772fb7b76b140f.png")
    private String url;
