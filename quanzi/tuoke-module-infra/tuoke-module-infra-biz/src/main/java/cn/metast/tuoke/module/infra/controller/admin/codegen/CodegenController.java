package cn.metast.tuoke.module.infra.controller.admin.codegen;
...
import cn.metast.tuoke.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.metast.tuoke.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.metast.tuoke.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.metast.tuoke.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.metast.tuoke.module.infra.convert.codegen.CodegenConvert;
...
import cn.metast.tuoke.module.infra.service.codegen.CodegenService;
...
import static cn.metast.tuoke.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "tuoke"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "元圈")
    })
