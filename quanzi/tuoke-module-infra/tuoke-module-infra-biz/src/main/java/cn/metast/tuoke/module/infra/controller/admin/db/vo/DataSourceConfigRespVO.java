package cn.metast.tuoke.module.infra.controller.admin.db.vo;
...
public class DataSourceConfigRespVO {
    ...
    @Schema(description = "数据源连接", requiredMode = Schema.RequiredMode.REQUIRED, example = "jdbc:mysql://127.0.0.1:3306/metast-vue-pro")
    private String url;
