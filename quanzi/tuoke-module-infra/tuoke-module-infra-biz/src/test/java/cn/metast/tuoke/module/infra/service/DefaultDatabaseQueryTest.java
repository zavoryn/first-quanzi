package cn.metast.tuoke.module.infra.service;
...
//                "root", "123456").build();
        DataSourceConfig dataSourceConfig = new DataSourceConfig.Builder("jdbc:postgresql://127.0.0.1:5432/metast-vue-pro",
                "root", "123456").build();
