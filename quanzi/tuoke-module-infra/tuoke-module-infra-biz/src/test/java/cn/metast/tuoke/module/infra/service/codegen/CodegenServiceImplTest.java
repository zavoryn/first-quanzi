package cn.metast.tuoke.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import cn.metast.tuoke.framework.common.pojo.PageResult;
import cn.metast.tuoke.framework.test.core.ut.BaseDbUnitTest;
import cn.metast.tuoke.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import cn.metast.tuoke.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import cn.metast.tuoke.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import cn.metast.tuoke.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import cn.metast.tuoke.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.metast.tuoke.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import cn.metast.tuoke.module.infra.dal.dataobject.codegen.CodegenTableDO;
import cn.metast.tuoke.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import cn.metast.tuoke.module.infra.dal.mysql.codegen.CodegenTableMapper;
import cn.metast.tuoke.module.infra.enums.codegen.CodegenFrontTypeEnum;
import cn.metast.tuoke.module.infra.enums.codegen.CodegenSceneEnum;
import cn.metast.tuoke.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import cn.metast.tuoke.module.infra.framework.codegen.config.CodegenProperties;
import cn.metast.tuoke.module.infra.service.codegen.inner.CodegenBuilder;
import cn.metast.tuoke.module.infra.service.codegen.inner.CodegenEngine;
import cn.metast.tuoke.module.infra.service.db.DatabaseTableService;
...
import static cn.metast.tuoke.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.metast.tuoke.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.metast.tuoke.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.metast.tuoke.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.metast.tuoke.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.metast.tuoke.framework.test.core.util.RandomUtils.*;
import static cn.metast.tuoke.module.infra.enums.ErrorCodeConstants.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        when(tableInfo.getComment()).thenReturn("元圈");
    ...
    public void testGetDatabaseTableList() {
        ...
        assertEquals("元圈", result.get(0).getComment());
    }
