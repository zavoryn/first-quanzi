...
import cn.metast.tuoke.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.metast.tuoke.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.metast.tuoke.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.metast.tuoke.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.metast.tuoke.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.metast.tuoke.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("tuoke-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("tuoke-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @元圈：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
