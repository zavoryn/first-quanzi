package cn.metast.tuoke.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testAliyun() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://ali-oss.metast.cn
        // 默认北京的 endpoint
    ...
    public void testQCloud() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://tengxun-oss.metast.cn
        // 默认上海的 endpoint
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("metast-vue-pro");
        config.setDomain("http://test.tuoke.metast.cn"); // 如果有自定义域名，则可以设置。http://static.tuoke.metast.cn
        // 默认上海的 endpoint
