...
import static cn.metast.tuoke.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseListenerConfig;
...
public class BpmUserTaskListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        // 2. 发起请求
        // TODO @元圈：哪些默认参数，后续再调研下；感觉可以搞个 task 字段，把整个 delegateTask 放进去；
