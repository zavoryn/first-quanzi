package cn.metast.tuoke.module.bpm.service.task;
...
import cn.metast.tuoke.framework.common.util.object.ObjectUtils;
...
import cn.metast.tuoke.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.metast.tuoke.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.metast.tuoke.module.bpm.controller.admin.task.vo.instance.*;
import cn.metast.tuoke.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.metast.tuoke.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.metast.tuoke.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.metast.tuoke.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.metast.tuoke.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.metast.tuoke.module.bpm.enums.ErrorCodeConstants;
import cn.metast.tuoke.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.metast.tuoke.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.metast.tuoke.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.metast.tuoke.module.bpm.enums.task.BpmReasonEnum;
import cn.metast.tuoke.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.metast.tuoke.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.metast.tuoke.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.metast.tuoke.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.metast.tuoke.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.metast.tuoke.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.metast.tuoke.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.metast.tuoke.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.metast.tuoke.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.metast.tuoke.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.metast.tuoke.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.metast.tuoke.module.bpm.service.message.BpmMessageService;
import cn.metast.tuoke.module.system.api.dept.DeptApi;
import cn.metast.tuoke.module.system.api.dept.dto.DeptRespDTO;
...
import static cn.metast.tuoke.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.metast.tuoke.module.bpm.enums.ErrorCodeConstants.*;
import static cn.metast.tuoke.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.metast.tuoke.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    private List<ActivityNode> getSimulateApproveNodeList(Long startUserId, BpmnModel bpmnModel,
                                                          ...
                                                          Map<String, Object> processVariables,
                                                          List<HistoricActivityInstance> activities) {
        // TODO @元圈：【可优化】在驳回场景下，未来的预测准确性不高。原因是，驳回后，HistoricActivityInstance
