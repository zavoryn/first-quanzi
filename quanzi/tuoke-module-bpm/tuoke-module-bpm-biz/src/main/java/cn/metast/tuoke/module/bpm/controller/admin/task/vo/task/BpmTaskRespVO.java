package cn.metast.tuoke.module.bpm.controller.admin.task.vo.task;
...
public class BpmTaskRespVO {
    ...
    @Schema(description = "任务名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
    private String name;
    ...
    public static class ProcessInstance {
        ...
        @Schema(description = "流程实例名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
        private String name;
