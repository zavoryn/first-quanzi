...
import cn.metast.tuoke.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
import cn.metast.tuoke.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
import cn.metast.tuoke.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import cn.metast.tuoke.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static cn.metast.tuoke.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("元圈")));
       // 测试 status 不匹配
