package cn.metast.tuoke.module.iot.plugin.emqx.upstream;

import cn.hutool.core.util.ArrayUtil;
import cn.metast.tuoke.module.iot.api.device.IotDeviceUpstreamApi;
import cn.metast.tuoke.module.iot.plugin.emqx.config.IotPluginEmqxProperties;
import cn.metast.tuoke.module.iot.plugin.emqx.upstream.router.IotDeviceAuthVertxHandler;
import cn.metast.tuoke.module.iot.plugin.emqx.upstream.router.IotDeviceMqttMessageHandler;
import cn.metast.tuoke.module.iot.plugin.emqx.upstream.router.IotDeviceWebhookVertxHandler;
...
public class IotDeviceUpstreamServer {
    ...
    public void start() {
        ...
        CompletableFuture.allOf(httpFuture, mqttFuture)
                .orTimeout(CONNECTION_TIMEOUT_MS, TimeUnit.MILLISECONDS) // TODO @元圈：JDK8 不兼容
