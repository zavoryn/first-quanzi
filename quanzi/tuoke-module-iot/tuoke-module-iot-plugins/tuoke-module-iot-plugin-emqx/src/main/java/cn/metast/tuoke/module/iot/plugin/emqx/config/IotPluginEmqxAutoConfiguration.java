package cn.metast.tuoke.module.iot.plugin.emqx.config;
...
import cn.metast.tuoke.module.iot.plugin.emqx.downstream.IotDeviceDownstreamHandlerImpl;
import cn.metast.tuoke.module.iot.plugin.emqx.upstream.IotDeviceUpstreamServer;
...
public class IotPluginEmqxAutoConfiguration {
    ...
    public MqttClient mqttClient(Vertx vertx, IotPluginEmqxProperties emqxProperties) {
        MqttClientOptions options = new MqttClientOptions()
                .setClientId("tuoke-iot-downstream-" + IdUtil.fastSimpleUUID())
