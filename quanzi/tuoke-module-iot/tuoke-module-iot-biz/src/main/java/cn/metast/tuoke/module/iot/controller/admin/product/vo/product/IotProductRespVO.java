package cn.metast.tuoke.module.iot.controller.admin.product.vo.product;
...
import cn.metast.tuoke.module.iot.enums.DictTypeConstants;
...
public class IotProductRespVO {
    ...
    @Schema(description = "产品图标", example = "https://metast.cn/1.svg")
    @ExcelProperty("产品图标")
    private String icon;

    @Schema(description = "产品图片", example = "https://metast.cn/1.png")
    @ExcelProperty("产品图片")
