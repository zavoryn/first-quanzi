package cn.metast.tuoke.module.iot.controller.admin.ota.vo.firmware;
...
public class IotOtaFirmwareRespVO implements VO {
     ...
     * 产品标识
     * <p>
     * 冗余 {@link cn.metast.tuoke.module.iot.dal.dataobject.product.IotProductDO#getProductKey()}
     */
     ...
     * 固件文件 URL
     */
    @Schema(description = "固件文件 URL", requiredMode = REQUIRED, example = "https://www.metast.cn")
