...
import cn.metast.tuoke.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwareCreateReqVO;
import cn.metast.tuoke.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwarePageReqVO;
import cn.metast.tuoke.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwareUpdateReqVO;
...
import cn.metast.tuoke.module.iot.dal.mysql.ota.IotOtaFirmwareMapper;
...
import static cn.metast.tuoke.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_NOT_EXISTS;
import static cn.metast.tuoke.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_PRODUCT_VERSION_DUPLICATE;
...
public class IotOtaFirmwareServiceImpl implements IotOtaFirmwareService {
     ...
     * @throws cn.metast.tuoke.framework.common.exception.ServiceException，则抛出异常，提示固件信息已存在
     */
