package cn.metast.tuoke.module.iot.service.ota;

import cn.hutool.core.convert.Convert;
import cn.metast.tuoke.framework.common.pojo.PageResult;
import cn.metast.tuoke.framework.common.util.object.ObjectUtils;
import cn.metast.tuoke.module.iot.controller.admin.ota.vo.upgrade.record.IotOtaUpgradeRecordPageReqVO;
import cn.metast.tuoke.module.iot.dal.dataobject.device.IotDeviceDO;
import cn.metast.tuoke.module.iot.dal.dataobject.ota.IotOtaFirmwareDO;
import cn.metast.tuoke.module.iot.dal.dataobject.ota.IotOtaUpgradeRecordDO;
import cn.metast.tuoke.module.iot.dal.dataobject.ota.IotOtaUpgradeTaskDO;
import cn.metast.tuoke.module.iot.dal.mysql.ota.IotOtaUpgradeRecordMapper;
import cn.metast.tuoke.module.iot.enums.ota.IotOtaUpgradeRecordStatusEnum;
...
public class IotOtaUpgradeRecordServiceImpl implements IotOtaUpgradeRecordService {
    ...
    public void cancelUpgradeRecordByTaskId(Long taskId) {
        // 暂定只有待推送的升级记录可以取消 TODO @元圈：可以看看阿里云，哪些可以取消
     ...
     * @throws cn.metast.tuoke.framework.common.exception.ServiceException，则抛出异常，异常类型为OTA_UPGRADE_RECORD_NOT_EXISTS。
     */
     ...
     * @throws cn.metast.tuoke.framework.common.exception.ServiceException，则抛出 OTA_UPGRADE_RECORD_CANNOT_RETRY 异常
     */
