package cn.metast.tuoke.module.iot.service.product;

import cn.metast.tuoke.framework.common.pojo.PageResult;
import cn.metast.tuoke.framework.common.util.object.BeanUtils;
import cn.metast.tuoke.framework.tenant.core.util.TenantUtils;
import cn.metast.tuoke.module.iot.controller.admin.product.vo.product.IotProductPageReqVO;
import cn.metast.tuoke.module.iot.controller.admin.product.vo.product.IotProductSaveReqVO;
import cn.metast.tuoke.module.iot.dal.dataobject.product.IotProductDO;
import cn.metast.tuoke.module.iot.dal.mysql.product.IotProductMapper;
...
public class IotProductServiceImpl implements IotProductService {
    ...
    public void updateProductStatus(Long id, Integer status) {
        ...
        // TODO @元圈：【待定 001】1）是否需要操作后，在 redis 进行缓存，实现一个“快照”的情况，类似 tl；
