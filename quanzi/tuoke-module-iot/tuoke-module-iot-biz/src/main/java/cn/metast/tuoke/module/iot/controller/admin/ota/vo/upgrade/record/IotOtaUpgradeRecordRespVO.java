package cn.metast.tuoke.module.iot.controller.admin.ota.vo.upgrade.record;
...
public class IotOtaUpgradeRecordRespVO {
     ...
     * 产品标识
     * <p>
     * 关联 {@link cn.metast.tuoke.module.iot.dal.dataobject.product.IotProductDO#getId()}
     */
     ...
     * 设备名称
     * <p>
     * 关联 {@link cn.metast.tuoke.module.iot.dal.dataobject.device.IotDeviceDO#getId()}
     */
     ...
     * 升级状态
     * <p>
     * 关联 {@link cn.metast.tuoke.module.iot.enums.ota.IotOtaUpgradeRecordStatusEnum}
     */
     ...
     * <p>
     * 注意，只记录设备最后一次的升级进度描述
     * 如果想看历史记录，可以查看 {@link cn.metast.tuoke.module.iot.dal.dataobject.device.IotDeviceLogDO} 设备日志
     */
