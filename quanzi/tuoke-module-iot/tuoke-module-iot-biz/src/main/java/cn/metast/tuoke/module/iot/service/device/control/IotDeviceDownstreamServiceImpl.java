...
import cn.metast.tuoke.module.iot.dal.dataobject.plugin.IotPluginInstanceDO;
...
import static cn.metast.tuoke.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED;
...
public class IotDeviceDownstreamServiceImpl implements IotDeviceDownstreamService {
    ...
    public IotDeviceMessage downstreamDevice(IotDeviceDownstreamReqVO downstreamReqVO) {
        ...
        // TODO @元圈：取消设备的网关的时，要不要下发 REGISTER_UNREGISTER_SUB ？
