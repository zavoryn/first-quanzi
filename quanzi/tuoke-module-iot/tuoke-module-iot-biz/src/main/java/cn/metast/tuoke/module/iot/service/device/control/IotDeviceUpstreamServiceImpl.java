...
import cn.metast.tuoke.module.iot.controller.admin.device.vo.control.IotDeviceUpstreamReqVO;
import cn.metast.tuoke.module.iot.dal.dataobject.device.IotDeviceDO;
import cn.metast.tuoke.module.iot.enums.device.IotDeviceMessageIdentifierEnum;
import cn.metast.tuoke.module.iot.enums.device.IotDeviceMessageTypeEnum;
import cn.metast.tuoke.module.iot.enums.device.IotDeviceStateEnum;
import cn.metast.tuoke.module.iot.enums.product.IotProductDeviceTypeEnum;
import cn.metast.tuoke.module.iot.mq.message.IotDeviceMessage;
import cn.metast.tuoke.module.iot.mq.producer.device.IotDeviceProducer;
import cn.metast.tuoke.module.iot.service.device.IotDeviceService;
import cn.metast.tuoke.module.iot.service.device.data.IotDevicePropertyService;
import cn.metast.tuoke.module.iot.service.plugin.IotPluginInstanceService;
import cn.metast.tuoke.module.iot.util.MqttSignUtils;
import cn.metast.tuoke.module.iot.util.MqttSignUtils.MqttSignResult;
