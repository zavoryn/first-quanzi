package cn.metast.tuoke.module.iot.job.device;
...
import cn.metast.tuoke.module.iot.service.device.control.IotDeviceUpstreamService;
 ...
 * IoT 设备离线检查 Job
 *
 * 检测逻辑：设备最后一条 {@link cn.metast.tuoke.module.iot.mq.message.IotDeviceMessage} 消息超过一定时间，则认为设备离线
 *
 * @author metast.cn
 */
@Component
public class IotDeviceOfflineCheckJob implements JobHandler {
     ...
     * 设备离线超时时间
     *
     * TODO 元圈：暂定 10 分钟，后续看看要不要基于设备或者全局有配置文件
     */
