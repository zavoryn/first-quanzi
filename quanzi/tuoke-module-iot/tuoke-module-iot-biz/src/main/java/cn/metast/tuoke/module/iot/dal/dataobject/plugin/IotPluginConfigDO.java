package cn.metast.tuoke.module.iot.dal.dataobject.plugin;
...
import cn.metast.tuoke.module.iot.enums.plugin.IotPluginTypeEnum;
...
public class IotPluginConfigDO extends TenantBaseDO {
    ...
    // TODO @元圈：如果是外置的插件，fileName 和 version 的选择~
    /**
     * 插件包文件名
     */
    ...
    // TODO @元圈：configSchema、config 示例字段
    /**
     * 插件配置项描述信息
     */
