...
import cn.metast.tuoke.module.iot.controller.admin.ota.vo.upgrade.task.IotOtaUpgradeTaskPageReqVO;
import cn.metast.tuoke.module.iot.controller.admin.ota.vo.upgrade.task.IotOtaUpgradeTaskSaveReqVO;
...
import cn.metast.tuoke.module.iot.dal.mysql.ota.IotOtaUpgradeTaskMapper;
import cn.metast.tuoke.module.iot.enums.ota.IotOtaUpgradeTaskScopeEnum;
import cn.metast.tuoke.module.iot.enums.ota.IotOtaUpgradeTaskStatusEnum;
...
public class IotOtaUpgradeTaskServiceImpl implements IotOtaUpgradeTaskService {
     ...
     * @throws cn.metast.tuoke.framework.common.exception.ServerException 则抛出预定义的异常
     */
     ...
     * @throws cn.metast.tuoke.framework.common.exception.ServiceException，抛出相应的异常
     */
     ...
     * @throws cn.metast.tuoke.framework.common.exception.ServiceException 如果升级任务不存在，则抛出异常提示任务不存在
     */
