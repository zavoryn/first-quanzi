package cn.metast.tuoke.module.iot.service.device.data;
...
import cn.metast.tuoke.module.iot.controller.admin.device.vo.data.IotDevicePropertyHistoryPageReqVO;
import cn.metast.tuoke.module.iot.controller.admin.device.vo.data.IotDevicePropertyRespVO;
import cn.metast.tuoke.module.iot.controller.admin.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import cn.metast.tuoke.module.iot.dal.dataobject.device.IotDeviceDO;
import cn.metast.tuoke.module.iot.dal.dataobject.device.IotDevicePropertyDO;
import cn.metast.tuoke.module.iot.dal.dataobject.product.IotProductDO;
import cn.metast.tuoke.module.iot.dal.dataobject.thingmodel.IotThingModelDO;
import cn.metast.tuoke.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import cn.metast.tuoke.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import cn.metast.tuoke.module.iot.dal.tdengine.IotDevicePropertyMapper;
import cn.metast.tuoke.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import cn.metast.tuoke.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import cn.metast.tuoke.module.iot.framework.tdengine.core.TDengineTableField;
import cn.metast.tuoke.module.iot.mq.message.IotDeviceMessage;
import cn.metast.tuoke.module.iot.service.device.IotDeviceService;
import cn.metast.tuoke.module.iot.service.product.IotProductService;
import cn.metast.tuoke.module.iot.service.thingmodel.IotThingModelService;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    private static final Map<String, String> TYPE_MAPPING = MapUtil.<String, String>builder()
            ...
            .put(IotDataSpecsDataTypeEnum.ENUM.getDataType(), TDengineTableField.TYPE_TINYINT) // TODO 元圈：为什么要映射为 TINYINT 的说明？
            .put(IotDataSpecsDataTypeEnum.BOOL.getDataType(), TDengineTableField.TYPE_TINYINT) // TODO 元圈：为什么要映射为 TINYINT 的说明？
            ...
            .put(IotDataSpecsDataTypeEnum.STRUCT.getDataType(), TDengineTableField.TYPE_NCHAR) // TODO 元圈：怎么映射！！！！
            .put(IotDataSpecsDataTypeEnum.ARRAY.getDataType(), TDengineTableField.TYPE_NCHAR) // TODO 元圈：怎么映射！！！！
            .build();
    ...
    public void saveDeviceProperty(IotDeviceMessage message) {
        ...
        // 2. 根据物模型，拼接合法的属性
        // TODO @元圈：【待定 004】赋能后，属性到底以 thingModel 为准（ik），还是 db 的表结构为准（tl）？
