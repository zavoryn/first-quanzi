package cn.metast.tuoke.module.iot.enums.device;

import lombok.Getter;
import lombok.RequiredArgsConstructor;

// TODO @元圈：需要添加对应的 DTO，以及上下行的链路，网关、网关服务、设备等
/**
 * IoT 设备消息标识符枚举
 */
@Getter
...
public enum IotDeviceMessageIdentifierEnum {
    ...
    PROPERTY_GET("get"), // 下行 TODO 元圈：【讨论】貌似这个“上行”更合理？device 主动拉取配置。和 IotDevicePropertyGetReqDTO 一样的配置
    PROPERTY_SET("set"), // 下行
    ...
    CONFIG_GET("get"), // 上行 TODO 元圈：【讨论】暂时没有上行的场景
    CONFIG_SET("set"), // 下行

    SERVICE_INVOKE("${identifier}"), // 下行
    SERVICE_REPLY_SUFFIX("_reply"), // 元圈：TODO 元圈：【讨论】上行 or 下行
