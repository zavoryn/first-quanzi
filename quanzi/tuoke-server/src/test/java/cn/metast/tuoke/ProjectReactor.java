...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.metast";
    private static final String ARTIFACT_ID = "tuoke";
    private static final String PACKAGE_NAME = "cn.metast.tuoke";
    private static final String TITLE = "拓客系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.metast";
        String artifactIdNew = "tuoke";
        String packageNameNew = "cn.metast.tuoke";
        String titleNew = "拓客系统";
        String projectBaseDirNew = "D:\\workspace_2024\\tuoke"; // 一键改名后，“新”项目所在的目录
