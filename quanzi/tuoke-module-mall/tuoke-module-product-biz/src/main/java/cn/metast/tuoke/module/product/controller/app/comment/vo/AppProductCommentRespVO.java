package cn.metast.tuoke.module.product.controller.app.comment.vo;

import cn.metast.tuoke.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductCommentRespVO {
    ...
    @Schema(description = "评价人头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/xx.png")
    ...
    @Schema(description = "追评评价图片地址数组，以逗号分隔最多上传 9 张", example = "[https://www.metast.cn/xx.png, https://www.metast.cn/xxx.png]")
    ...
    @Schema(description = "评论图片地址数组，以逗号分隔最多上传 9 张", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "[https://www.metast.cn/xx.png]")
