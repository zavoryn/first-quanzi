package cn.metast.tuoke.module.product.dal.mysql.spu;
...
import cn.metast.tuoke.module.product.enums.ProductConstants;
...
public interface ProductSpuMapper extends BaseMapperX<ProductSpuDO> {
     ...
     * @return 触发警戒库存的 SPU 数量
     */
    default ProductSpuDO getResourceId(String resourceId) {
        LambdaQueryWrapperX<ProductSpuDO> queryWrapper = new LambdaQueryWrapperX<>();
        queryWrapper.eq(ProductSpuDO::getResourceId, resourceId).last("limit 1");
        return selectOne(queryWrapper);
    }
    default ProductSpuDO getSpuByName(String name) {
        LambdaQueryWrapperX<ProductSpuDO> queryWrapper = new LambdaQueryWrapperX<>();
        queryWrapper.eq(ProductSpuDO::getName, name).last("limit 1");
        return selectOne(queryWrapper);
    }
