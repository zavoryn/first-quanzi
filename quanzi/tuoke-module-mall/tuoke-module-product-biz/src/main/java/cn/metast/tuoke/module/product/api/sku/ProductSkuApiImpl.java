package cn.metast.tuoke.module.product.api.sku;
...
public class ProductSkuApiImpl implements ProductSkuApi {
    ...
    @Override
    public ProductSkuRespDTO getOrderSkuId(String skuId) {
        ProductSkuDO sku = productSkuService.getOrderSkuId(skuId);
        return BeanUtils.toBean(sku, ProductSkuRespDTO.class);
    }
    ...
    @Override
    public List<ProductSkuRespDTO> getSkuListBySpuId(Long spuId) {
