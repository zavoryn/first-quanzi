package cn.metast.tuoke.module.product.controller.admin.spu.vo;
...
import cn.metast.tuoke.module.product.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/xx.png")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.metast.cn/xx.png, https://www.metast.cn/xxx.png]")
