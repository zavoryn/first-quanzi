package cn.metast.tuoke.module.product.dal.mysql.sku;
...
public interface ProductSkuMapper extends BaseMapperX<ProductSkuDO> {
    ...
    default ProductSkuDO getOrderSkuId(String skuId){
        LambdaQueryWrapperX<ProductSkuDO> queryWrapper = new LambdaQueryWrapperX<>();
        queryWrapper.eq(ProductSkuDO::getOrderSkuId, skuId).last("limit 1");
