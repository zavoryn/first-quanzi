...
import cn.metast.tuoke.module.product.controller.admin.spu.vo.ProductSpuUpdateStatusReqVO;
import cn.metast.tuoke.module.product.controller.app.spu.vo.AppProductSpuPageReqVO;
...
public class ProductSpuServiceImpl implements ProductSpuService {
    ...
    public int setSpusExplainStatus(){
        LambdaUpdateWrapper<ProductSpuDO> updateWrapper = new LambdaUpdateWrapper<ProductSpuDO>()
                .setSql(" jj_status = 0 " );
        int i = productSpuMapper.update(null, updateWrapper);
        return i;
    }
    @Override
    @TenantIgnore
    public int setSpuExplainStatus(Long id, int jjStatus){
        ...
        productSpuDO.setId(id);
        productSpuDO.setJjStatus(jjStatus);
        int i = productSpuMapper.updateById(productSpuDO);
        return i;
    }

    @Override
    public ProductSpuDO getSpuByName(String name) {
        return productSpuMapper.getSpuByName(name);
    }

    @Override
    public ProductSpuDO getResourceId(String resourceId) {
        return productSpuMapper.getResourceId(resourceId);
    }
