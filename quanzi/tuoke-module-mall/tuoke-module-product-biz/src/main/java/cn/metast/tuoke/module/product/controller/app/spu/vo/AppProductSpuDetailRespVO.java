package cn.metast.tuoke.module.product.controller.app.spu.vo;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
    private String name;
    ...
    public static class Sku {
        ...
        @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/xx.png")
        private String picUrl;
