package cn.metast.tuoke.module.product.controller.admin.comment.vo;
...
public class ProductCommentRespVO {
    ...
    @Schema(description = "商品 SKU 图片地址", example = "https://www.metast.cn/tuoke.jpg")
    ...
    @Schema(description = "评论图片地址数组，以逗号分隔最多上传 9 张", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.metast.cn/xx.png]")
