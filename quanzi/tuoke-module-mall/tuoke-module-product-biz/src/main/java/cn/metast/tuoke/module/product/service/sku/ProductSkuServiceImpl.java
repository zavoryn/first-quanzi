...
import cn.metast.tuoke.module.product.convert.sku.ProductSkuConvert;
...
public class ProductSkuServiceImpl implements ProductSkuService {
    ...
    @Override
    public ProductSkuDO getOrderSkuId(String id) {
        return productSkuMapper.getOrderSkuId(id);
    }
