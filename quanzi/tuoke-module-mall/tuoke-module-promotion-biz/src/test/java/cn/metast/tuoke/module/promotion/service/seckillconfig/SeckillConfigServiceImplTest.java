package cn.metast.tuoke.module.promotion.service.seckillconfig;

import cn.metast.tuoke.framework.test.core.ut.BaseDbUnitTest;
import cn.metast.tuoke.module.promotion.controller.admin.seckill.vo.config.SeckillConfigCreateReqVO;
import cn.metast.tuoke.module.promotion.controller.admin.seckill.vo.config.SeckillConfigUpdateReqVO;
import cn.metast.tuoke.module.promotion.dal.dataobject.seckill.SeckillConfigDO;
import cn.metast.tuoke.module.promotion.dal.mysql.seckill.seckillconfig.SeckillConfigMapper;
import cn.metast.tuoke.module.promotion.service.seckill.SeckillConfigServiceImpl;
...
import static cn.metast.tuoke.module.promotion.enums.ErrorCodeConstants.SECKILL_CONFIG_NOT_EXISTS;
...
@Disabled // TODO 元圈：未来开启；后续要 review 下
