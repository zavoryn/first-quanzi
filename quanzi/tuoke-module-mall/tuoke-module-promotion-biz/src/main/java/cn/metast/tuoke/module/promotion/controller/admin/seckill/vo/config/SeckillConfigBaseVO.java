package cn.metast.tuoke.module.promotion.controller.admin.seckill.vo.config;
...
public class SeckillConfigBaseVO {
    ...
    @Schema(description = "秒杀轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.metast.cn/xx.png]")
