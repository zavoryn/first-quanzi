...
public interface KeFuConversationService {
    ...
    KeFuConversationDO getOrCreateConversation(Long userId, Long receiverId,Long topicId);

    KeFuConversationDO getOrCreateConversationGroup(Long userId, Long receiverId);
    /**
     * 校验客服会话是否存在
     *
     * @param id 编号
    ...
    List<KeFuConversationDO> getConversationListByUserId(Long userId);

    List<KeFuConversationDO> getKefuConversationList_admin();
    List<KeFuConversationDO> getKefuConversationList_web(Long receiverId);

    List<KeFuConversationDO> getKefuConversationListTopId(Long topicId,String nickName);
