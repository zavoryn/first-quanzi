...
import cn.metast.tuoke.module.promotion.controller.admin.bargain.vo.help.BargainHelpPageReqVO;
import cn.metast.tuoke.module.promotion.controller.app.bargain.vo.help.AppBargainHelpCreateReqVO;
import cn.metast.tuoke.module.promotion.dal.dataobject.bargain.BargainActivityDO;
import cn.metast.tuoke.module.promotion.dal.dataobject.bargain.BargainHelpDO;
import cn.metast.tuoke.module.promotion.dal.dataobject.bargain.BargainRecordDO;
import cn.metast.tuoke.module.promotion.dal.mysql.bargain.BargainHelpMapper;
...
public class BargainHelpServiceImpl implements BargainHelpService {
    ...
    // TODO 元圈：优化点：实现一个更随机的逻辑，可以按照你自己的业务；
