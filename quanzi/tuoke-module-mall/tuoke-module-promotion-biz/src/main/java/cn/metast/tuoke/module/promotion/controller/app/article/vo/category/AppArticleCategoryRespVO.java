package cn.metast.tuoke.module.promotion.controller.app.article.vo.category;
...
public class AppArticleCategoryRespVO {
    ...
    @Schema(description = "分类图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/1.png")
