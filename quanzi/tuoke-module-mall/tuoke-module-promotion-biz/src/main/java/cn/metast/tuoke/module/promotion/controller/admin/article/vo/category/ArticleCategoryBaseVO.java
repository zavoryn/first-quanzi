package cn.metast.tuoke.module.promotion.controller.admin.article.vo.category;
...
public class ArticleCategoryBaseVO {
    ...
    @Schema(description = "图标地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn")
