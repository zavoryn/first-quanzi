package cn.metast.tuoke.module.promotion.controller.app.article.vo.article;
...
public class AppArticleRespVO {
    ...
    @Schema(description = "文章标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈 - 促销模块")
    private String title;

    @Schema(description = "文章作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
    private String author;

    @Schema(description = "分类编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "2048")
    private Long categoryId;

    @Schema(description = "图文封面", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/1.png")
