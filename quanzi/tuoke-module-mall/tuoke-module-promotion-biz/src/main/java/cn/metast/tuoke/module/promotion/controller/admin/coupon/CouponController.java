package cn.metast.tuoke.module.promotion.controller.admin.coupon;
...
import cn.metast.tuoke.module.promotion.controller.admin.coupon.vo.coupon.CouponPageItemRespVO;
import cn.metast.tuoke.module.promotion.controller.admin.coupon.vo.coupon.CouponPageReqVO;
import cn.metast.tuoke.module.promotion.controller.admin.coupon.vo.coupon.CouponSendReqVO;
import cn.metast.tuoke.module.promotion.convert.coupon.CouponConvert;
import cn.metast.tuoke.module.promotion.dal.dataobject.coupon.CouponDO;
import cn.metast.tuoke.module.promotion.service.coupon.CouponService;
import cn.metast.tuoke.module.promotion.service.sync.CouponSyncService;
...
public class CouponController {
    ...
    @GetMapping("/syncCouponUserRecord")
    @Operation(summary = "同步小鹅通优惠卷领取记录")
    @PreAuthorize("@ss.hasPermission('promotion:coupon:sync')")
    public CommonResult<Boolean> syncCouponUserRecord() {
        couponSyncService.syncCouponUserRecord();
        return success(true);
    }
