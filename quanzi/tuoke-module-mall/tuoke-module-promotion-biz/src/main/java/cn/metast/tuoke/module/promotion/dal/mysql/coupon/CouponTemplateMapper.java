package cn.metast.tuoke.module.promotion.dal.mysql.coupon;
...
public interface CouponTemplateMapper extends BaseMapperX<CouponTemplateDO> {
    ...
    default  CouponTemplateDO selectByCouponId(String couponId){
        return selectOne(CouponTemplateDO::getCouponId,couponId);
    }
