package cn.metast.tuoke.module.promotion.controller.admin.combination.vo.recrod;
...
public class CombinationRecordBaseVO {
    ...
    @Schema(description = "用户昵称", example = "老元圈")
    private String nickname;

    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/xxx.jpg")
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/1.png")
