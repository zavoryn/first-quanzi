...
import cn.metast.tuoke.module.promotion.controller.admin.coupon.vo.template.*;
...
public class CouponTemplateController {
    ...
    @GetMapping("/syncCoupon")
    @Operation(summary = "同步小鹅通优惠卷")
    @PreAuthorize("@ss.hasPermission('promotion:coupon-template:sync')")
    public CommonResult<Boolean> syncCoupon() {
        couponSyncService.syncTechCoupon();
        return success(true);
    }
    @GetMapping("/list")
