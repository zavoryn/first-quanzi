package cn.metast.tuoke.module.promotion.service.combination;
...
import cn.metast.tuoke.module.promotion.api.combination.dto.CombinationValidateJoinRespDTO;
import cn.metast.tuoke.module.promotion.controller.admin.combination.vo.recrod.CombinationRecordReqPageVO;
import cn.metast.tuoke.module.promotion.controller.app.combination.vo.record.AppCombinationRecordPageReqVO;
import cn.metast.tuoke.module.promotion.convert.combination.CombinationActivityConvert;
...
import cn.metast.tuoke.module.promotion.dal.mysql.combination.CombinationRecordMapper;
...
import static cn.metast.tuoke.framework.common.util.date.LocalDateTimeUtils.afterNow;
import static cn.metast.tuoke.framework.common.util.date.LocalDateTimeUtils.beforeNow;
import static cn.metast.tuoke.module.promotion.enums.ErrorCodeConstants.*;
import static cn.metast.tuoke.module.promotion.enums.MessageTemplateConstants.COMBINATION_SUCCESS;

// TODO 元圈：等拼团记录做完，完整 review 下
