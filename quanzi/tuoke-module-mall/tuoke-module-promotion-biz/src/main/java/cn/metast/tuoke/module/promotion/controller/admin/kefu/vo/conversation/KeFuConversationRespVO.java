package cn.metast.tuoke.module.promotion.controller.admin.kefu.vo.conversation;
...
public class KeFuConversationRespVO {
    ...
    private Long userId;
    @Schema(description = "会话接收用户", requiredMode = Schema.RequiredMode.REQUIRED, example = "8300")
    private Long receiverId;
    @Schema(description = "会话所属用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://tuoke.com/images/avatar.jpg")
    private String userAvatar;
    @Schema(description = "会话所属用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
