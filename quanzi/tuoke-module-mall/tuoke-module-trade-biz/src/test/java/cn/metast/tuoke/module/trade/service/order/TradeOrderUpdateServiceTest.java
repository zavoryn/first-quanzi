...
import cn.metast.tuoke.module.promotion.api.coupon.CouponApi;
import cn.metast.tuoke.module.system.api.notify.NotifyMessageSendApi;
import cn.metast.tuoke.module.trade.controller.admin.delivery.vo.express.DeliveryExpressCreateReqVO;
import cn.metast.tuoke.module.trade.controller.admin.order.vo.TradeOrderDeliveryReqVO;
...
import cn.metast.tuoke.module.trade.enums.order.TradeOrderRefundStatusEnum;
import cn.metast.tuoke.module.trade.enums.order.TradeOrderStatusEnum;
import cn.metast.tuoke.module.trade.framework.order.config.TradeOrderConfig;
import cn.metast.tuoke.module.trade.framework.order.config.TradeOrderProperties;
import cn.metast.tuoke.module.trade.service.cart.CartServiceImpl;
import cn.metast.tuoke.module.trade.service.delivery.DeliveryExpressService;
import cn.metast.tuoke.module.trade.service.delivery.DeliveryExpressServiceImpl;
import cn.metast.tuoke.module.trade.service.message.TradeMessageServiceImpl;
import cn.metast.tuoke.module.trade.service.order.handler.TradeOrderHandler;
import cn.metast.tuoke.module.trade.service.price.TradePriceServiceImpl;
import cn.metast.tuoke.module.trade.service.price.calculator.TradePriceCalculator;
...
//        // mock 方法（用户收件地址的校验）
//        MemberAddressRespDTO addressRespDTO = new MemberAddressRespDTO().setId(10L).setUserId(userId).setName("元圈")
...
//        assertEquals(tradeOrderDO.getReceiverName(), "元圈");
