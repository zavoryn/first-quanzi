...
public interface TradeOrderUpdateService {
    ...
    void deliveryOrderByNo(TradeOrderDeliveryReqVO deliveryReqVO);
     ...
     * @param reqVO 请求
     */
    int updateOrderAddress(TradeOrderUpdateAddressReqVO reqVO);
    ...
    TradeOrderDO selectByNo(String no);

    TradeOrderImportRespVO importShipmentDate(List<TradeOrderShipmentRespVO> list, boolean isUpdateSupport);
}
