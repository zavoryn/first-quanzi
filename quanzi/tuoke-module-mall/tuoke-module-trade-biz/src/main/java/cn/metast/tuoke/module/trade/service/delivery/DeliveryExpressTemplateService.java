...
import cn.metast.tuoke.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateCreateReqVO;
import cn.metast.tuoke.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateDetailRespVO;
import cn.metast.tuoke.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplatePageReqVO;
import cn.metast.tuoke.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateUpdateReqVO;
...
public interface DeliveryExpressTemplateService {
     ...
     * 校验快递运费模板
     *
     * 如果校验不通过，抛出 {@link cn.metast.tuoke.framework.common.exception.ServiceException} 异常
     *
