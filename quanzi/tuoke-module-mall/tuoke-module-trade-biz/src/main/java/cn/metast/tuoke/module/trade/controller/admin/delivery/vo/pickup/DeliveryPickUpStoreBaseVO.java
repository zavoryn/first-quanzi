package cn.metast.tuoke.module.trade.controller.admin.delivery.vo.pickup;
...
public class DeliveryPickUpStoreBaseVO {
    ...
    @Schema(description = "门店 logo", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/1.png")
