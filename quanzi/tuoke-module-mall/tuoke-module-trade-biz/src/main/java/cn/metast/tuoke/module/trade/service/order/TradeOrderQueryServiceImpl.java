...
import cn.metast.tuoke.module.trade.controller.admin.order.vo.TradeOrderSummaryRespVO;
import cn.metast.tuoke.module.trade.controller.app.order.vo.AppTradeOrderPageReqVO;
...
import cn.metast.tuoke.module.trade.dal.redis.RedisKeyConstants;
...
import cn.metast.tuoke.module.trade.framework.delivery.core.client.ExpressClientFactory;
import cn.metast.tuoke.module.trade.framework.delivery.core.client.dto.ExpressTrackQueryReqDTO;
...
import static cn.metast.tuoke.module.trade.enums.ErrorCodeConstants.EXPRESS_NOT_EXISTS;
import static cn.metast.tuoke.module.trade.enums.ErrorCodeConstants.ORDER_NOT_FOUND;
...
public class TradeOrderQueryServiceImpl implements TradeOrderQueryService {
    ...
    @Override
    public Long getOrderCountBySj(Integer status, Boolean commentStatus) {
        return tradeOrderMapper.selectCountByUserIdAndStatusBySj(status, commentStatus);
    }
