package cn.metast.tuoke.module.trade.controller.admin.config.vo;
...
public class TradeConfigBaseVO {
    ...
    @Schema(description = "分销海报图地址数组", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.metast.cn/tuoke.jpg]")
