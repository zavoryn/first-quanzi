package cn.metast.tuoke.module.trade.controller.admin.aftersale;
...
import cn.metast.tuoke.module.trade.controller.admin.aftersale.vo.*;
...
public class AfterSaleController {
    ...
    @GetMapping("/syncTechAfterOrder")
    @Operation(summary = "同步小鹅通售后订单")
    @PreAuthorize("@ss.hasPermission('trade:after-sale:sync')")
    public CommonResult<Boolean> syncTechAfterOrder() {
        orderSyncService.syncTechAfterOrder();
        return success(true);
    }
