...
public interface TradeOrderItemMapper extends BaseMapperX<TradeOrderItemDO> {
    ...
    default TradeOrderItemDO selectOrderSkuId(Long orderId,Long sku_id,String order_sku_id) {
        return selectOne(new MPJLambdaWrapperX<TradeOrderItemDO>()
                .eq(TradeOrderItemDO::getOrderId, orderId)
                .eq(TradeOrderItemDO::getSkuId, sku_id)
                .eq(TradeOrderItemDO::getOrderSkuId, order_sku_id)
                .last("LIMIT 1"));
    }
