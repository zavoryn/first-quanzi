...
import cn.metast.tuoke.module.infra.enums.DictTypeConstants;
...
public class CrmClueRespVO {
    ...
    @DictFormat(cn.metast.tuoke.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY)
    private Integer industryId;

    @Schema(description = "客户等级", requiredMode = Schema.RequiredMode.REQUIRED, example = "13563")
    @ExcelProperty(value = "客户等级", converter = DictConvert.class)
    @DictFormat(cn.metast.tuoke.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_LEVEL)
    private Integer level;

    @Schema(description = "客户来源", requiredMode = Schema.RequiredMode.REQUIRED, example = "13563")
    @ExcelProperty(value = "客户来源", converter = DictConvert.class)
    @DictFormat(cn.metast.tuoke.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_SOURCE)
    ...
    @Schema(description = "创建人名字", example = "元圈")
    @ExcelProperty("创建人名字")
