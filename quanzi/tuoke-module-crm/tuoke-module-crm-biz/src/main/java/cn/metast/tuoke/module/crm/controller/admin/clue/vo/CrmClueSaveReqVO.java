package cn.metast.tuoke.module.crm.controller.admin.clue.vo;

import cn.metast.tuoke.framework.common.validation.InEnum;
import cn.metast.tuoke.framework.common.validation.Mobile;
import cn.metast.tuoke.framework.common.validation.Telephone;
import cn.metast.tuoke.framework.excel.core.annotations.DictFormat;
import cn.metast.tuoke.module.crm.enums.customer.CrmCustomerLevelEnum;
import cn.metast.tuoke.module.crm.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import cn.metast.tuoke.module.crm.framework.operatelog.core.CrmCustomerLevelParseFunction;
import cn.metast.tuoke.module.crm.framework.operatelog.core.CrmCustomerSourceParseFunction;
import cn.metast.tuoke.module.crm.framework.operatelog.core.SysAreaParseFunction;
...
import static cn.metast.tuoke.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;
...
public class CrmClueSaveReqVO {
    ...
    @Schema(description = "客户公司名称", example = "true")
