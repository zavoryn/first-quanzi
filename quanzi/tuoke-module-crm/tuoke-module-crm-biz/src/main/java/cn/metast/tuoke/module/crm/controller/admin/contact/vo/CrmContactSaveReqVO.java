package cn.metast.tuoke.module.crm.controller.admin.contact.vo;

import cn.metast.tuoke.framework.common.validation.Mobile;
import cn.metast.tuoke.framework.common.validation.Telephone;
import cn.metast.tuoke.module.crm.framework.operatelog.core.*;
...
public class CrmContactSaveReqVO {
    ...
    @Schema(description = "姓名", example = "元圈")
