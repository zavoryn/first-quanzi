package cn.metast.tuoke.module.crm.controller.admin.product.vo.product;
...
import cn.metast.tuoke.module.crm.enums.DictTypeConstants;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "cn.metast.tuoke.module.system.dal.dataobject.user.AdminUserDO",
            fields = "nickname", ref = "ownerUserName")
    private Long ownerUserId;
    @Schema(description = "负责人的用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
    @ExcelProperty("负责人")
    ...
    @Schema(description = "创建人名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "元圈")
    @ExcelProperty("创建人")
