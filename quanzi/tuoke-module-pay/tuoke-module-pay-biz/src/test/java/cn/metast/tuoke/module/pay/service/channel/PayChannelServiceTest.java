...
import cn.metast.tuoke.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import cn.metast.tuoke.framework.pay.core.client.impl.weixin.WxPayClientConfig;
...
public class PayChannelServiceTest extends BaseDbUnitTest {
    ...
    public void testGetPayClient() {
        ...
        when(payClientFactory.createOrUpdatePayClient(eq(id), eq(channel.getCode()), eq(payClientConfig)))
    ...
    public PayClientConfig getYlswPayClientConfig(PayChannelDO channel) {
        ...
        List<PayClientConfig> configs = (List<PayClientConfig>) configObj;
