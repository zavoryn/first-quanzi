package cn.metast.tuoke.module.pay.controller.admin.notify.vo;
...
public class PayNotifyTaskBaseVO {
    ...
    @Schema(description = "异步通知地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn")
