package cn.metast.tuoke.module.pay.framework.pay.config;
...
@ConfigurationProperties(prefix = "tuoke.pay")
@Validated
@Data
public class PayProperties {
     ...
     *
     * 回调顺序：支付渠道（支付宝支付、微信支付） => tuoke-module-pay 的 orderNotifyUrl 地址 => 业务的 PayAppDO.orderNotifyUrl 地址
     */
     ...
     *
     * 回调顺序：支付渠道（支付宝支付、微信支付） => tuoke-module-pay 的 refundNotifyUrl 地址 => 业务的 PayAppDO.notifyRefundUrl 地址
     */
    @NotEmpty(message = "支付回调地址不能为空")
    @URL(message = "支付回调地址的格式必须是 URL")
     ...
     *
     * 回调顺序：支付渠道（支付宝支付、微信支付） => tuoke-module-pay 的 transferNotifyUrl 地址 => 业务的 PayAppDO.transferNotifyUrl 地址
     */
