package cn.metast.tuoke.module.pay.convert.order;
...
import cn.metast.tuoke.module.pay.controller.app.order.vo.AppPayOrderSubmitRespVO;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.metast.tuoke.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
