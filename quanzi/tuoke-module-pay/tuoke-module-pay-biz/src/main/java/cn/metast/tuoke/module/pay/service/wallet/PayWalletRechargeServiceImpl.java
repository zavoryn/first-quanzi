package cn.metast.tuoke.module.pay.service.wallet;
...
import cn.metast.tuoke.module.pay.controller.app.wallet.vo.recharge.AppPayWalletRechargeCreateReqVO;
...
import cn.metast.tuoke.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import static cn.metast.tuoke.framework.common.util.number.MoneyUtils.fenToYuanStr;
import static cn.metast.tuoke.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static cn.metast.tuoke.module.pay.enums.ErrorCodeConstants.*;
import static cn.metast.tuoke.module.pay.enums.MessageTemplateConstants.WXA_WALLET_RECHARGER_PAID;
import static cn.metast.tuoke.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @元圈：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
