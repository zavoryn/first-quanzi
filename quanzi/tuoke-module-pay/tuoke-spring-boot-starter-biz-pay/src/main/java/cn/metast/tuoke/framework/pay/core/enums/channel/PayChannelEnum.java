package cn.metast.tuoke.framework.pay.core.enums.channel;
...
public enum PayChannelEnum {
    ...
    YLSW_LITE("ylsw_lite", "微信小程序支付", YlswPayClientConfig.class),
    YLSW_APP("ylsw_app", "微信 App 支付", YlswPayClientConfig.class),
    YLSW_WAP("ylsw_wap", "微信 Wap 网站支付", YlswPayClientConfig.class), // H5 网页
    ...
    UNKNOWN("unknown", "未知", NonePayClientConfig.class),
