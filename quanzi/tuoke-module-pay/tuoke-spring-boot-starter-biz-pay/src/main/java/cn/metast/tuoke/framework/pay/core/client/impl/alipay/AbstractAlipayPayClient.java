package cn.metast.tuoke.framework.pay.core.client.impl.alipay;
...
import static cn.metast.tuoke.framework.pay.core.client.impl.alipay.AlipayPayClientConfig.MODE_CERTIFICATE;
...
public abstract class AbstractAlipayPayClient extends AbstractPayClient<AlipayPayClientConfig> {
    ...
    protected PayTransferRespDTO doUnifiedTransfer(PayTransferUnifiedReqDTO reqDTO) throws AlipayApiException {
        ...
        switch (transferType) {
            ...
            // @元圈。 是不是还要考虑转账到银行卡。所以传 transferType 但是转账到银行卡不知道要如何测试??
            case ALIPAY_BALANCE: {
