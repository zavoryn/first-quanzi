package cn.metast.tuoke.framework.pay.core.client.impl;
...
import cn.metast.tuoke.framework.pay.core.client.impl.alipay.*;
import cn.metast.tuoke.framework.pay.core.client.impl.mock.MockPayClient;
import cn.metast.tuoke.framework.pay.core.client.impl.weixin.*;
import cn.metast.tuoke.framework.pay.core.client.impl.ylsw.YlswPayClient;
...
import static cn.metast.tuoke.framework.pay.core.enums.channel.PayChannelEnum.*;
import static cn.metast.tuoke.framework.pay.core.enums.channel.PayChannelEnum.YLSW_WAP;
...
public class PayClientFactoryImpl implements PayClientFactory {
    ...
    public PayClientFactoryImpl() {
        // 银联支付支付客户端
        clientClass.put(YLSW_LITE, YlswPayClient.class);
        clientClass.put(YLSW_APP, YlswPayClient.class);
        clientClass.put(YLSW_WAP, YlswPayClient.class);
        // 微信支付客户端
    ...
    @Override
    @SuppressWarnings("unchecked")
    public <Config extends PayClientConfig> PayClient createOrUpdatePayClientByYlsw(Long channelId, String channelCode,
                                                                                    Config config) {
        AbstractPayClient<Config> client = (AbstractPayClient<Config>) clients.get(channelId);
        if (client == null) {
            client = this.createPayClient(channelId, channelCode, config);
