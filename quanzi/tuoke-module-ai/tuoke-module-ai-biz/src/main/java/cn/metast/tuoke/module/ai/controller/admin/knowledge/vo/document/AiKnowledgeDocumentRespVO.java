package cn.metast.tuoke.module.ai.controller.admin.knowledge.vo.document;
...
public class AiKnowledgeDocumentRespVO {
    ...
    @Schema(description = "文档 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://doc.metast.cn")
    private String url;
