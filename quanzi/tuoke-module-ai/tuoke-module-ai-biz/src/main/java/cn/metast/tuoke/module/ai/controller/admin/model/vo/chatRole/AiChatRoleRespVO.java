package cn.metast.tuoke.module.ai.controller.admin.model.vo.chatRole;
...
public class AiChatRoleRespVO implements VO {
    ...
    @Schema(description = "角色头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.metast.cn/1.png")
