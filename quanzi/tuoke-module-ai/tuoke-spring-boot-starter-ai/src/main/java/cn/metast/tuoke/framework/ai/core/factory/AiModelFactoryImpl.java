package cn.metast.tuoke.framework.ai.core.factory;
...
import cn.metast.tuoke.framework.ai.config.TuokeAiAutoConfiguration;
import cn.metast.tuoke.framework.ai.config.TuokeAiProperties;
...
import cn.metast.tuoke.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.metast.tuoke.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
import cn.metast.tuoke.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            TuokeAiProperties.MidjourneyProperties properties = SpringUtil.getBean(TuokeAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link TuokeAiAutoConfiguration#deepSeekChatModel(TuokeAiProperties)}
     */
    private static DeepSeekChatModel buildDeepSeekChatModel(String apiKey) {
        TuokeAiProperties.DeepSeekProperties properties = new TuokeAiProperties.DeepSeekProperties()
                .setApiKey(apiKey);
        return new TuokeAiAutoConfiguration().buildDeepSeekChatModel(properties);
    }

    /**
     * 可参考 {@link TuokeAiAutoConfiguration#douBaoChatClient(TuokeAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        TuokeAiProperties.DouBaoProperties properties = new TuokeAiProperties.DouBaoProperties()
                .setApiKey(apiKey);
        return new TuokeAiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link TuokeAiAutoConfiguration#hunYuanChatClient(TuokeAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        TuokeAiProperties.HunYuanProperties properties = new TuokeAiProperties.HunYuanProperties()
                .setBaseUrl(url).setApiKey(apiKey);
        return new TuokeAiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link TuokeAiAutoConfiguration#siliconFlowChatClient(TuokeAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        TuokeAiProperties.SiliconFlowProperties properties = new TuokeAiProperties.SiliconFlowProperties()
                .setApiKey(apiKey);
        return new TuokeAiAutoConfiguration().buildSiliconFlowChatClient(properties);
    }
    ...
    /**
     * 可参考 {@link TuokeAiAutoConfiguration#xingHuoChatClient(TuokeAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        TuokeAiProperties.XingHuoProperties properties = new TuokeAiProperties.XingHuoProperties()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new TuokeAiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link TuokeAiAutoConfiguration#baiChuanChatClient(TuokeAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        TuokeAiProperties.BaiChuanProperties properties = new TuokeAiProperties.BaiChuanProperties()
                .setApiKey(apiKey);
        return new TuokeAiAutoConfiguration().buildBaiChuanChatClient(properties);
    }
