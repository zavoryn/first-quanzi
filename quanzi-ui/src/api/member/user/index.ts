...
// 同步长者用户
export const syncMainUser = async (data: any) => {
  return await request.post({ url: `/member/jg-user/syncMemberUser`, data })
}
// 下载用户导入模板
...
//同步会员用户
export const syncMemberUser= () => {
  return request.get({ url: '/member/user/syncMemberUser' })
}
