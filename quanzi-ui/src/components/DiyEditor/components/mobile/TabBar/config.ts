    ...
    items: [
      {
        ...
        iconUrl: 'https://qt982.oss-cn-hangzhou.aliyuncs.com/wennuan/images/1-001.png',
        activeIconUrl: 'https://qt982.oss-cn-hangzhou.aliyuncs.com/wennuan/images/1-002.png'
      },
      {
        text: '分类',
        url: '/pages/index/category?id=3',
        iconUrl: 'https://qt982.oss-cn-hangzhou.aliyuncs.com/wennuan/images/2-001.png',
        activeIconUrl: 'https://qt982.oss-cn-hangzhou.aliyuncs.com/wennuan/images/2-002.png'
      },
      {
        text: '购物车',
        url: '/pages/index/cart',
        iconUrl: 'https://qt982.oss-cn-hangzhou.aliyuncs.com/wennuan/images/3-001.png',
        activeIconUrl: 'https://qt982.oss-cn-hangzhou.aliyuncs.com/wennuan/images/3-002.png'
      },
      {
        text: '我的',
        url: '/pages/index/user',
        iconUrl: 'https://qt982.oss-cn-hangzhou.aliyuncs.com/wennuan/images/4-001.png',
        activeIconUrl: 'https://qt982.oss-cn-hangzhou.aliyuncs.com/wennuan/images/4-002.png'
      }
    ]
  }
